...
#DEFINE TITULOAPP_LOC			'POSITIVO GESTION'
...
#DEFINE WIN_COMMAND_LOC	     	'Command'                     && ventana de comandos
#DEFINE WIN_PROYECT_LOC	     	'Administrador de proyectos'  && ventana del adm. de proyectos
